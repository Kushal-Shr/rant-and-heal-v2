...
export default function SettingsPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <section className="clay-card p-7"><h2 className="text-xl font-medium text-[#325347]">Download your data</h2><p className="mt-2 text-sm leading-6 text-[#414845]">Export your profile, coarse journal activity, check-ins, Momo conversations, and therapy relationship records as JSON. Encrypted journal content is excluded because this server-side export never reads your Vault documents.</p><Button className="mt-5" isLoading={busy === "export"} onClick={exportData}>Download export</Button></section>

...
export function TherapistProfileCard({
  ...
  return (
    <article className="flex h-full flex-col rounded-[2.5rem] bg-white p-6 sm:p-7 text-[#2c1601] shadow-[0_20px_40px_-10px_rgba(121,88,65,0.1),0_10px_15px_-5px_rgba(121,88,65,0.05),inset_0_2px_4px_rgba(255,255,255,0.8)]">
      <div className="mb-6 flex flex-wrap items-start gap-4">
        <Avatar alt={name} initials={initials} size="lg" src={imageSrc} />
        <div>
          <h3 className="font-['Plus_Jakarta_Sans'] text-xl font-medium leading-[1.4] text-[#2c1601]">
            {name}
          </h3>
      ...
      <Button className="w-full" disabled={disabled} isLoading={isLoading} onClick={onConnect} variant="outline">
        {ctaLabel}
      </Button>
    </article>
  );
